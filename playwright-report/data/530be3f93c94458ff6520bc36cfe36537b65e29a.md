...
- Name: smoke-test.spec.ts >> Production Smoke Tests >> should reject login with wrong password
- Location: tests/smoke-test.spec.ts:58:3
  ...
  - generic [ref=e8]:
    ...
    - generic [ref=e11]:
      ...
      - generic [ref=e16]:
        ...
        - generic [ref=e18]:
          - textbox "Password" [ref=e19]: WrongPassword123
          - group:
            - generic: Password

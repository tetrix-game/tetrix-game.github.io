...
- Name: smoke-test.spec.ts >> Production Smoke Tests >> should reject login with non-existent account
- Location: tests/smoke-test.spec.ts:73:3
  ...
  - generic [ref=e8]:
    ...
    - generic [ref=e11]:
      - generic [ref=e12]:
        ...
        - generic [ref=e14]:
          - textbox "Email" [ref=e15]: nonexistent1777053231771@example.com
          - group:
            - generic: Email
      - generic [ref=e16]:
...
> 83  |     await expect(page.locator('text=/invalid/i')).toBeVisible({ timeout: 5000 });
  ...
  144 |       await expect(page.locator('[data-testid="game-board"]')).toBeVisible();
  145 |     }
  146 |   });
  147 | });
  148 | 

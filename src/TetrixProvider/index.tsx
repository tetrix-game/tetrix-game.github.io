...
export function useTetrixDispatchContext(): TetrixDispatch {
  ...
  if (!context) {
    throw new Error('useTetrixDispatchContext must be used within a TetrixProvider');
  }
  return context;
}
...
export function useTetrixStateContext(): TetrixReducerState {
  ...
  if (!context) {
    throw new Error('useTetrixStateContext must be used within a TetrixProvider');
  }
  return context;
}

type InitializationState = 'BOOTING' | 'LOADING' | 'READY' | 'FAILURE';
export function TetrixProvider(

...
describe('ShapeIcon Component', () => {
  ...
  test('should apply custom size when provided', () => {
    const customSize = 48;
    const { container } = render(<Shared_ShapeIcon color="red" size={customSize} />);
    const svg = container.querySelector('svg');
  ...
  test('should apply custom opacity when provided', () => {
    ...
    const { container } = render(<Shared_ShapeIcon color="blue" opacity={customOpacity} />);
    const svg = container.querySelector('svg');
  ...
  test('should render different shapes for different colors', () => {
    ...
    const { container: redContainer } = render(<Shared_ShapeIcon color="red" />);
    expect(redContainer.querySelector('circle')).toBeTruthy();

    // Orange should have a polygon (triangle)
    const { container: orangeContainer } = render(<Shared_ShapeIcon color="orange" />);
    ...
    const { container: yellowContainer } = render(<Shared_ShapeIcon color="yellow" />);
  ...
  test('should use default opacity of 1 when not provided', () => {
    const { container } = render(<Shared_ShapeIcon color="purple" />);
    const svg = container.querySelector('svg');

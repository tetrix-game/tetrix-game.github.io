...
import { performLineClearing } from '../lineClearingOrchestrator';
...
const { generateRandomShapeWithGrandpaMode } = shapeGenerationWithProbabilities;
const { detectSuperComboPattern } = shapePatterns;
